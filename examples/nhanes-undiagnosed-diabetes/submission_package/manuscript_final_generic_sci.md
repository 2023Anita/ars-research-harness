...
Running title: Undiagnosed diabetes in NHANES 2017-2018
...
Funding: [To be completed; state no funding if applicable]

Conflicts of interest: [To be completed; state none if applicable]

Word count: 7,812 words before target-journal formatting
...
- Supplementary Table 1: BMI alternative model (`tables/supplementary_table_bmi_model.md`).

- Supplementary Table 2: categorical screening model (`tables/supplementary_table_categorical_model.md`).

- Supplementary Table 3: fasting-weighted HbA1c/FPG sensitivity prevalence (`tables/supplementary_table_fasting_sensitivity.md`).

- Supplementary Table 4: covariate missingness (`tables/covariate_missingness.md`).
